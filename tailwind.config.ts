    ...
    extend: {
      ...
      colors: {
        ...
        success: {
          ...
          light: "hsl(var(--valid-green-light))",
        },
        warning: {
        ...
        tiss: {
          blue: "hsl(var(--tiss-blue))",
          "blue-light": "hsl(var(--tiss-blue-light))",
          teal: "hsl(var(--tiss-teal))",
          "teal-light": "hsl(var(--tiss-teal-light))",
        },
        valid: {
          green: "hsl(var(--valid-green))",
          "green-light": "hsl(var(--valid-green-light))",
        },
        error: {
          red: "hsl(var(--error-red))",
          "red-light": "hsl(var(--error-red-light))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
